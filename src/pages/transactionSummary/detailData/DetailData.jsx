...
const DetailData = ({ dataColumn, itemListColumn,
  ...
  //     return {}
  //   }
  //   else if(processType === 'grn' && (key === 'crAddress')){
  //     return {}
  //   }
  ...
  //   }
  //   else if((processType === "grn" || processType === "rn" ) && key === "approvedName"){
  //     return { title: "Returned / Submitted By", dataIndex: key };
  //   }
  //   else if((processType === "grn" ) && key === "issueName"){
  //     return { title: "Verified By", dataIndex: key };
  //   }
  //   else{
